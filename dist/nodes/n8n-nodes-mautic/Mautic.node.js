...
class MauticRest {
    constructor() {
        this.description = {
            displayName: 'MauticRest',
            name: 'mautic',
            icon: 'file:mautic.svg',
            group: ['output'],
            version: 1,
            subtitle: '={{$parameter["operation"] + ": " + $parameter["resource"]}}',
            description: 'Consume Mautic Rest API',
            defaults: {
                name: 'MauticRest',
            },
            usableAsTool: true,
            ...
            try {
                if (resource === 'company') {
                    if (operation === 'create') {
                        ...
                        const { addressUi, customFieldsUi, companyEmail, fax, industry, numberOfEmployees, phone, website, annualRevenue, description, ...rest } = this.getNodeParameter('additionalFields', i);
                    ...
                    if (operation === 'update') {
                        ...
                        const simple = this.getNodeParameter('simple', i);
                        const body = {};
                        const { addressUi, customFieldsUi, companyEmail, name, fax, industry, numberOfEmployees, phone, website, annualRevenue, description, ...rest } = this.getNodeParameter('updateFields', i);
                        if (addressUi === null || addressUi === void 0 ? void 0 : addressUi.addressValues) {
                            const { addressValues } = addressUi;
                            body.companyaddress1 = addressValues.address1;
                            body.companyaddress2 = addressValues.address2;
